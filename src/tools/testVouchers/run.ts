...
/**
 * Running one voucher test and shaping its result.
 *
 * Split out of testVouchers.ts at 908 lines. `runProcedure` is the dispatch to
 * src/audit/procedures — pure arithmetic on the other side of it — and this is
 * where a procedure's output becomes a tool payload.
 */
